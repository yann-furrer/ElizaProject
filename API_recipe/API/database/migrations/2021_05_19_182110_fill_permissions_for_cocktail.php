...
class FillPermissionsForCocktail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCocktail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cocktail',
            'admin.cocktail.index',
            'admin.cocktail.create',
            'admin.cocktail.show',
            'admin.cocktail.edit',
            'admin.cocktail.delete',
            'admin.cocktail.bulk-delete',
        ]);
