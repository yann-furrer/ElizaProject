...
class FillPermissionsForIngredientCocktail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForIngredientCocktail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ingredient-cocktail',
            'admin.ingredient-cocktail.index',
            'admin.ingredient-cocktail.create',
            'admin.ingredient-cocktail.show',
            'admin.ingredient-cocktail.edit',
            'admin.ingredient-cocktail.delete',
            'admin.ingredient-cocktail.bulk-delete',
        ]);
