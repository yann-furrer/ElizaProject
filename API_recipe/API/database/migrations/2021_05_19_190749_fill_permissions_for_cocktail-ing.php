...
class FillPermissionsForCocktailIng extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCocktailIng constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cocktail-ing',
            'admin.cocktail-ing.index',
            'admin.cocktail-ing.create',
            'admin.cocktail-ing.show',
            'admin.cocktail-ing.edit',
            'admin.cocktail-ing.delete',
            'admin.cocktail-ing.bulk-delete',
        ]);
