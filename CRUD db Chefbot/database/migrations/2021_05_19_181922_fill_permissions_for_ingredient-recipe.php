...
class FillPermissionsForIngredientRecipe extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForIngredientRecipe constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ingredient-recipe',
            'admin.ingredient-recipe.index',
            'admin.ingredient-recipe.create',
            'admin.ingredient-recipe.show',
            'admin.ingredient-recipe.edit',
            'admin.ingredient-recipe.delete',
            'admin.ingredient-recipe.bulk-delete',
        ]);
