...
class FillPermissionsForRecipeIng extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRecipeIng constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.recipe-ing',
            'admin.recipe-ing.index',
            'admin.recipe-ing.create',
            'admin.recipe-ing.show',
            'admin.recipe-ing.edit',
            'admin.recipe-ing.delete',
            'admin.recipe-ing.bulk-delete',
        ]);
